...
export default function NewRestaurantPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.tableNumber) {
      ...
      newErrors.tableNumber = 'Must have at least 1 table';
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Create your restaurant profile and get a QR code</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1">
                  <label className="block">
                    ...
                    />
                    <div className="flex cursor-pointer items-center gap-2 rounded-lg border-2 border-dashed border-gray-300 px-4 py-3 text-sm font-medium text-gray-600 transition-colors hover:border-indigo-300 hover:text-indigo-600">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 w-full rounded-lg border px-3 py-2 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 ${errors.contactName ? 'border-red-300' : 'border-gray-300'}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 w-full rounded-lg border px-3 py-2 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 ${errors.primaryEmail ? 'border-red-300' : 'border-gray-300'}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 w-full rounded-lg border px-3 py-2 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 ${errors.contactPhone ? 'border-red-300' : 'border-gray-300'}`}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-2 rounded-lg bg-blue-50 border border-blue-200 p-3">
                    <p className="text-xs text-blue-800">
                      <strong>💡 Tip:</strong> This UPI ID will receive payments directly from customers. Works with GPay, PhonePe, Paytm, BHIM, and all UPI apps.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm">
              ...
              <div>
                ...
                <div className="mt-1 flex rounded-lg border border-gray-300 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500">
                  ...
                  <input
                    ...
                    className="flex-1 rounded-r-lg border-0 px-3 py-2 focus:outline-none"
